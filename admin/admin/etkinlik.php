...
if (isset($_SESSION['k_ad']))
{
  ...
  $duyurusor=$db->prepare("SELECT * FROM yazi where k_id=:kul_id and t_id=:tid");
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        <div class="">
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      <?php while ($duyurucek=$duyurusor->fetch(PDO::FETCH_ASSOC)) { ?>
                        ...
                        <tr>
                          <td>  <?php echo $duyurucek['yazi'] ?> </td>
                          <td> <a href="../../islem.php?kullanici_id=<?php echo $duyurucek['k_id'];?>&duyurusil=ok&yazi_id=<?php echo $duyurucek['yazi_id']; ?>"> <button class="btn btn-secondary" > SİL</button></a></td>
          ...
          <a href="ekleetkinlik.php">yeni ekle</a>
        </div>
      </div>
      <!-- /page content -->
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <a href="ekleetkinlik.html">yeni ekle</a>
          </div>
        </div>
        <!-- /page content -->
